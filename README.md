...
### Other dependencies
This reflects how I like ot organize my machine, pick what works for you. The control_file.paths reflects this setup. If you choose to install the bellow packages in different locations, just change control_file.paths to reflect this.
```
Path_to_gits=~/gits
mkdir ~/$Path_to_gits
cd ~/$Path_to_gits/
